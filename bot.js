...
client.on('message', message => {
    if (message.content === prefix +'help') {
    	message.reply('Hello im Dj_Ghostly-Star personal assistant, my commands are the following with out quotation marks , bot commands about the menu ! , " $status " , " $s " , " Download " , " $features " , " $gta5-key " ,  Other bot commands! " $help " , " $ping " , " $bing " , " no " , " yes " ," hi " , " hello " , " hi " ," Bye " , " Goodbye " , " Goodnight " , " night ". ');
  	}
